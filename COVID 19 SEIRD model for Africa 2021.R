...
params = c(popsize = Pop, birthrate=Anbirthrate,  lambda=lambdah,iota = iotah,
    ...
    b3 = b31, rho =roh, theta1 = thetah1, theta2 = thetah2,epsilon=epsilonh, 
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentAdupdateed.xlsx", sheetName =COUNTRY, append=TRUE)
...
#### A new variant that is more reinfectious than the delta by -40%, 0%, 40%, 80%, and 120%

####### change the ephsilonh at those levels in the DynCovInitGAReinf.txt initializing data set with a dominance of 90%

##########################################################################


setwd("F:/Epi Modelling COVID-19/Data/Analytics/Filter/Country_Models_Gamma_Noise/Improved two in one model/Case scenarios")
rm(list = ls()) # removing the objects in the memory
ls()
...
params = c(popsize = Pop*(1-prop_pop_imm_21), birthrate=Anbirthrate,  lambda=lambdah,iota = iotah,
    gamma1 = gammah1,gamma2 = gammah2,
    mu = muh, mu2=CFR1, lam=lam, CFR=CFR1,b1 = b11, b2 = b21,b4=b41,b5=b51,
    b3 = b31, rho =roh, theta1 = thetah1, theta2 = thetah2,epsilon=epsilonh_40, 
    sigmaSE = 0.03, S1_0 = 0.55 , E1_0 = 0.01 ,  I1_0 =0.01 , R1_0 = 0.01, D1_0 = 0.0,
    S2_0 = 0.4 , E2_0 = 0.01 ,  I2_0 =0.01 , R2_0 = 0.01, D2_0 = 0.0,
    contact_rate=contact_rateh,severity_var=severity_var,sev_reduce=sev_reduce,
    infect_reduce=infect_reduce,epsilonh_reduce=epsilonh_reduce,mort_reduce=mort_reduce),seed = 1914679908L) -> sir2C6AA
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentEpsi_40.xlsx", sheetName =COUNTRY, append=TRUE)
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentEpsi0.xlsx", sheetName =COUNTRY, append=TRUE)
...
params = c(popsize = Pop*(1-prop_pop_imm_21), birthrate=Anbirthrate,  lambda=lambdah,iota = iotah,
    gamma1 = gammah1,gamma2 = gammah2,
    mu = muh, mu2=CFR1, lam=lam, CFR=CFR1,b1 = b11, b2 = b21,b4=b41,b5=b51,
    b3 = b31, rho =roh, theta1 = thetah1, theta2 = thetah2,epsilon=epsilonh40, 
    sigmaSE = 0.03, S1_0 = 0.55 , E1_0 = 0.01 ,  I1_0 =0.01 , R1_0 = 0.01, D1_0 = 0.0,
    S2_0 = 0.4 , E2_0 = 0.01 ,  I2_0 =0.01 , R2_0 = 0.01, D2_0 = 0.0,
    contact_rate=contact_rateh,severity_var=severity_var,sev_reduce=sev_reduce,
    infect_reduce=infect_reduce,epsilonh_reduce=epsilonh_reduce,mort_reduce=mort_reduce),seed = 1914679908L) -> sir2C6AA
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentEpsi40.xlsx", sheetName =COUNTRY, append=TRUE)
...
Sever=data.frame(Asymptomatic,lowAsy,highAsy,Moderate,lowMod, highMod,Severec,lowSev,higSev, Critical,lowCrit,highCrit,DNs,Dlow,Dhigh)
...
params = c(popsize = Pop*(1-prop_pop_imm_21), birthrate=Anbirthrate,  lambda=lambdah,iota = iotah,
    gamma1 = gammah1,gamma2 = gammah2,
    mu = muh, mu2=CFR1, lam=lam, CFR=CFR1,b1 = b11, b2 = b21,b4=b41,b5=b51,
    b3 = b31, rho =roh, theta1 = thetah1, theta2 = thetah2,epsilon=epsilonh400, 
    sigmaSE = 0.03, S1_0 = 0.55 , E1_0 = 0.01 ,  I1_0 =0.01 , R1_0 = 0.01, D1_0 = 0.0,
    S2_0 = 0.4 , E2_0 = 0.01 ,  I2_0 =0.01 , R2_0 = 0.01, D2_0 = 0.0,
    contact_rate=contact_rateh,severity_var=severity_var,sev_reduce=sev_reduce,
    infect_reduce=infect_reduce,epsilonh_reduce=epsilonh_reduce,mort_reduce=mort_reduce),seed = 1914679908L) -> sir2C6AA
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentEpsi400.xlsx", sheetName =COUNTRY, append=TRUE)

}


sheet = excel_sheets("CurrentEpsi_40.xlsx")
Combined_country_dataEpsi_40 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentEpsi_40.xlsx", sheet=x))
Combined_country_dataEpsi_40 = bind_rows(Combined_country_dataEpsi_40, .id="Sheet")
Combined_country_dataEpsi_40 =as.data.frame(Combined_country_dataEpsi_40)
Combined_country_dataEpsi_40$Date <- as.Date(Combined_country_dataEpsi_40$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataEpsi_40, "Combined_country_dataEpsi_40.xlsx")
head(Combined_country_dataEpsi_40)



sheet = excel_sheets("CurrentEpsi0.xlsx")
Combined_country_dataEpsi0 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentEpsi0.xlsx", sheet=x))
Combined_country_dataEpsi0 = bind_rows(Combined_country_dataEpsi0, .id="Sheet")
Combined_country_dataEpsi0 =as.data.frame(Combined_country_dataEpsi0)
Combined_country_dataEpsi0$Date <- as.Date(Combined_country_dataEpsi0$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataEpsi0, "Combined_country_dataEpsi0.xlsx")
head(Combined_country_dataEpsi0)


sheet = excel_sheets("CurrentEpsi40.xlsx")
Combined_country_dataEpsi40 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentEpsi40.xlsx", sheet=x))
Combined_country_dataEpsi40 = bind_rows(Combined_country_dataEpsi40, .id="Sheet")
Combined_country_dataEpsi40 =as.data.frame(Combined_country_dataEpsi40)
Combined_country_dataEpsi40$Date <- as.Date(Combined_country_dataEpsi40$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataEpsi40, "Combined_country_dataEpsi40.xlsx")
head(Combined_country_dataEpsi40)
...
head(Combined_country_dataEpsi200)


sheet = excel_sheets("CurrentEpsi400.xlsx")
Combined_country_dataEpsi400 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentEpsi400.xlsx", sheet=x))
Combined_country_dataEpsi400 = bind_rows(Combined_country_dataEpsi400, .id="Sheet")
Combined_country_dataEpsi400 =as.data.frame(Combined_country_dataEpsi400)
Combined_country_dataEpsi400$Date <- as.Date(Combined_country_dataEpsi400$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataEpsi400, "Combined_country_dataEpsi400.xlsx")
head(Combined_country_dataEpsi400)
...
#### A new variant that is more severe than the delta by -40%, 0%, 40%, 80%, 120%, 200% and 400%

####### adjust the rates[] 8 and 9 accordingly uising in the DynCovInitGATrans.txt initializing data set with a dominance of 70%
...
seas.sir.step2 <- "
  ...
  rate[6] = gamma1; // recovery rate1
  rate[7] = gamma2; // recovery rate2
  rate[8] = 0.6*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class1
  rate[9] = 0.6*(1-immun/(popsize))*(1-mort_reduce)*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class2
  rate[10] = mu; // death from recovered class1
  rate[11] = mu; // death from recovered class2
  rate[12] = mu; // death from I_1
  rate[13] = mu; // death from I_2
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"Currentsev_40.xlsx", sheetName =COUNTRY, append=TRUE)
...
seas.sir.step2 <- "
  ...
  rate[6] = gamma1; // recovery rate1
  rate[7] = gamma2; // recovery rate2
  rate[8] = 1*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class1
  rate[9] = 1*(1-immun/(popsize))*(1-mort_reduce)*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class2
  rate[10] = mu; // death from recovered class1
  rate[11] = mu; // death from recovered class2
  rate[12] = mu; // death from I_1
  rate[13] = mu; // death from I_2
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"Currentsev0.xlsx", sheetName =COUNTRY, append=TRUE)
...
seas.sir.step2 <- "
  ...
  rate[6] = gamma1; // recovery rate1
  rate[7] = gamma2; // recovery rate2
  rate[8] = 1.4*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class1
  rate[9] = 1.4*(1-immun/(popsize))*(1-mort_reduce)*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class2
  rate[10] = mu; // death from recovered class1
  rate[11] = mu; // death from recovered class2
  rate[12] = mu; // death from I_1
  rate[13] = mu; // death from I_2
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"Currentsev40.xlsx", sheetName =COUNTRY, append=TRUE)
...
seas.sir.step2 <- "
  ...
  rate[6] = gamma1; // recovery rate1
  rate[7] = gamma2; // recovery rate2
  rate[8] = 5*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class1
  rate[9] = 5*(1-immun/(popsize))*(1-mort_reduce)*mu2*Beta*(I + iota) / (popsize); // covid deaths from infectious class2
  rate[10] = mu; // death from recovered class1
  rate[11] = mu; // death from recovered class2
  rate[12] = mu; // death from I_1
  rate[13] = mu; // death from I_2
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"Currentsev400.xlsx", sheetName =COUNTRY, append=TRUE)

}


sheet = excel_sheets("Currentsev_40.xlsx")
Combined_country_datasev_40 = lapply(setNames(sheet, sheet), function(x) read_excel("Currentsev_40.xlsx", sheet=x))
Combined_country_datasev_40 = bind_rows(Combined_country_datasev_40, .id="Sheet")
Combined_country_datasev_40 =as.data.frame(Combined_country_datasev_40)
Combined_country_datasev_40$Date <- as.Date(Combined_country_datasev_40$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_datasev_40, "Combined_country_datasev_40.xlsx")
head(Combined_country_datasev_40)


sheet = excel_sheets("Currentsev0.xlsx")
Combined_country_datasev0 = lapply(setNames(sheet, sheet), function(x) read_excel("Currentsev0.xlsx", sheet=x))
Combined_country_datasev0 = bind_rows(Combined_country_datasev0, .id="Sheet")
Combined_country_datasev0 =as.data.frame(Combined_country_datasev0)
Combined_country_datasev0$Date <- as.Date(Combined_country_datasev0$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_datasev0, "Combined_country_datasev0.xlsx")
head(Combined_country_datasev0)


sheet = excel_sheets("Currentsev40.xlsx")
Combined_country_datasev40 = lapply(setNames(sheet, sheet), function(x) read_excel("Currentsev40.xlsx", sheet=x))
Combined_country_datasev40 = bind_rows(Combined_country_datasev40, .id="Sheet")
Combined_country_datasev40 =as.data.frame(Combined_country_datasev40)
Combined_country_datasev40$Date <- as.Date(Combined_country_datasev40$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_datasev40, "Combined_country_datasev40.xlsx")
head(Combined_country_datasev40)
...
sheet = excel_sheets("Currentsev400.xlsx")
Combined_country_datasev400 = lapply(setNames(sheet, sheet), function(x) read_excel("Currentsev400.xlsx", sheet=x))
Combined_country_datasev400 = bind_rows(Combined_country_datasev400, .id="Sheet")
Combined_country_datasev400 =as.data.frame(Combined_country_datasev400)
Combined_country_datasev400$Date <- as.Date(Combined_country_datasev400$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_datasev400, "Combined_country_datasev400.xlsx")
head(Combined_country_datasev400)
...
#### A new variant that is more transmissible than the delta by -40%, 0%, 40%, 80%, 120%, 200% and 400%

####### increase the future1_trans by the percentage increases in the DynCovInitGATrans.txt initializing data set with a dominance of 90%
...
#calculating variant severities
severity_var = (alpha_prop*alpha_trans+beta_prop*beta_trans+delta_prop*delta_trans
   +ref_var_prop*reference_trans+future1_prop*future1_trans*(0.6)+future2_prop*future2_trans)
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentTrans_40.xlsx", sheetName =COUNTRY, append=TRUE)
...
#calculating variant severities
severity_var = (alpha_prop*alpha_trans+beta_prop*beta_trans+delta_prop*delta_trans
   +ref_var_prop*reference_trans+future1_prop*future1_trans*(1)+future2_prop*future2_trans)
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentTrans0.xlsx", sheetName =COUNTRY, append=TRUE)
...
#calculating variant severities
severity_var = (alpha_prop*alpha_trans+beta_prop*beta_trans+delta_prop*delta_trans
   +ref_var_prop*reference_trans+future1_prop*future1_trans*(1.4)+future2_prop*future2_trans)
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentTrans40.xlsx", sheetName =COUNTRY, append=TRUE)
...
#calculating variant severities
severity_var = (alpha_prop*alpha_trans+beta_prop*beta_trans+delta_prop*delta_trans
   +ref_var_prop*reference_trans+future1_prop*future1_trans*(5)+future2_prop*future2_trans)
...
library(readxl)
library(WriteXLS)
write.xlsx2(StatesFull,"CurrentTrans400.xlsx", sheetName =COUNTRY, append=TRUE)
...
sheet = excel_sheets("CurrentTrans_40.xlsx")
Combined_country_dataTrans_40 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentTrans_40.xlsx", sheet=x))
Combined_country_dataTrans_40 = bind_rows(Combined_country_dataTrans_40, .id="Sheet")
Combined_country_dataTrans_40 =as.data.frame(Combined_country_dataTrans_40)
Combined_country_dataTrans_40$Date <- as.Date(Combined_country_dataTrans_40$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataTrans_40, "Combined_country_dataTrans_40.xlsx")
head(Combined_country_dataTrans_40)


sheet = excel_sheets("CurrentTrans0.xlsx")
Combined_country_dataTrans0 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentTrans0.xlsx", sheet=x))
Combined_country_dataTrans0 = bind_rows(Combined_country_dataTrans0, .id="Sheet")
Combined_country_dataTrans0 =as.data.frame(Combined_country_dataTrans0)
Combined_country_dataTrans0$Date <- as.Date(Combined_country_dataTrans0$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataTrans0, "Combined_country_dataTrans0.xlsx")
head(Combined_country_dataTrans0)



sheet = excel_sheets("CurrentTrans40.xlsx")
Combined_country_dataTrans40 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentTrans40.xlsx", sheet=x))
Combined_country_dataTrans40 = bind_rows(Combined_country_dataTrans40, .id="Sheet")
Combined_country_dataTrans40 =as.data.frame(Combined_country_dataTrans40)
Combined_country_dataTrans40$Date <- as.Date(Combined_country_dataTrans40$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataTrans40, "Combined_country_dataTrans40.xlsx")
head(Combined_country_dataTrans40)
...
sheet = excel_sheets("CurrentTrans400.xlsx")
Combined_country_dataTrans400 = lapply(setNames(sheet, sheet), function(x) read_excel("CurrentTrans400.xlsx", sheet=x))
Combined_country_dataTrans400 = bind_rows(Combined_country_dataTrans400, .id="Sheet")
Combined_country_dataTrans400 =as.data.frame(Combined_country_dataTrans400)
Combined_country_dataTrans400$Date <- as.Date(Combined_country_dataTrans400$Date,format = "%m/%d/%Y")
write.xlsx (Combined_country_dataTrans400, "Combined_country_dataTrans400.xlsx")
head(Combined_country_dataTrans400)
